...
FILE_P = os.path.join(HERE, 'hypar_loaded.png')

cablenet = Cablenet.from_json(FILE_I)

cablenet.attributes['density'] = 20.0
cablenet.vertices_attribute('t', 0.2)
...
al = proxy.apply_loads_proxy
cablenetdata = al(cablenet.to_data())
