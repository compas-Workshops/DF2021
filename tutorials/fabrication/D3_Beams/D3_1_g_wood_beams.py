...
polyartist = PolylineArtist(polyline, layer="DF21_D3::Beam::Bdr1::local")
polyartist.clear_layer()
polyartist.draw(show_points=True)
polyartist = PolylineArtist(polyline_o, layer="DF21_D3::Beam::Bdr1::local")
polyartist.draw(show_points=True)

polyartist = PolylineArtist(polyline_i_T, layer="DF21_D3::Beam::Bdr1::XY")
polyartist.clear_layer()
polyartist.draw(show_points=True)
polyartist = PolylineArtist(polyline_o_T, layer="DF21_D3::Beam::Bdr1::XY")
polyartist.draw(show_points=True)
