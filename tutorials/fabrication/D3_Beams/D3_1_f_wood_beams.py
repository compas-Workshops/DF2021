...
polyartist = PolylineArtist(polyline_o, layer="DF2021:: Beam:: Seam:: local")
polyartist.draw(show_points=True)

polyartist = PolylineArtist(polyline_i_T, layer="DF2021:: Beam:: Seam:: XY")
polyartist.clear_layer()
polyartist.draw(show_points=True)
polyartist = PolylineArtist(polyline_o_T, layer="DF2021:: Beam:: Seam:: XY")
polyartist.draw(show_points=True)
