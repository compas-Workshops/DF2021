...
from compas.geometry import normalize_vector, cross_vectors, subtract_vectors, dot_vectors
...
polyartist = PolylineArtist(polyline, layer="DF21_D3::Beam::Bdr2::local")
polyartist.clear_layer()
polyartist.draw(show_points=True)
polyartist = PolylineArtist(polyline_o, layer="DF21_D3::Beam::Bdr2::local")
polyartist.draw(show_points=True)

polyartist = PolylineArtist(polyline_i_T, layer="DF21_D3::Beam::Bdr2::XY")
polyartist.clear_layer()
polyartist.draw(show_points=True)
polyartist = PolylineArtist(polyline_o_T, layer="DF21_D3::Beam::Bdr2::XY")
polyartist.draw(show_points=True)
