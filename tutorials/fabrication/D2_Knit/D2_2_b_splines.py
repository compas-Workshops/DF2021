...
for (u, v) in mesh.edges():
    if (mesh.vertex_attribute(u, 'is_anchor')
       and mesh.vertex_attribute(v, 'is_anchor')):
...
compas_rhino.draw_cylinders(lines, layer="DF21_D2::KnitPatch2::Spline",
                            clear=False, redraw=True, cap=True)
mesh.to_json(FILE_I)
