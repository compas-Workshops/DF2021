...
# store previous selfweight loads for which the cablemesh was formfound > c. NEW  # noqa: E501
loads_previous = mesh.vertices_attributes(('px', 'py', 'pz'))

# recompute selfweight for the updated geometry > c. NEW
selfweight(mesh)

# recompute the residuals with difference of selfweight from updated to previous geometry > c. NEW  # noqa: E501
residuals = update_residual(mesh, loads_previous)
print(residuals)
...
baselayer = "DF21_C2::08 Concrete Selfweight_d2"
