...
dva = {
    ...
    't': 0.035            # Thickness of the concrete shell.
}
mesh.update_default_vertex_attributes(dva)

# set default edge attributes
dea = {
    'q': 0.19,             # Force densities of an edge.
...
mesh.edges_attribute('q', 10, keys=cables[1*factor]+cables[3*factor])
...
baselayer = "DF21_C2::09 Refinement_b_0.19_10"
